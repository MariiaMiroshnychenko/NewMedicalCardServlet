...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a href="${pageContext.request.contextPath}/mirmedis/doctor-appointment" class="nav-link"><fmt:message key="navbar.appointments"/> </a>
            </li>
    ...
    <form method="get" action="${pageContext.request.contextPath}/change-lang/mirmedis/doctorPage">
...
<style>
    ...
    #real-estates-detail .sosmed-author i {
        width: 30px;
        height: 30px;
                    ...
                    <div class="panel-heading">
                        <header class="panel-title">
                            <div class="text-center">
                                <strong><fmt:message key="message.doctor"/></strong>
                            </div>
                        </header>
                    </div>
